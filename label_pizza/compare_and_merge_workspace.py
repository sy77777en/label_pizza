...
def compare_videos(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def compare_users(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def compare_schemas(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def compare_projects(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def compare_project_groups(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def compare_assignments(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def compare_question_groups(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def compare_annotations(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def compare_ground_truths(folder1_path: str, folder2_path: str, write_to_file: bool = False) -> bool:
    """
...
def merge_videos(folder1_path: str, folder2_path: str, output_path: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing videos.json
        folder2_path (str): Path to second folder containing videos.json
        output_path (str): Path for merged videos.json output
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
    ...
    for key, item in dict2.items():
        if key in merged_dict:
            if merged_dict[key] != item:
                ...
                # Use gt_folder to resolve conflict
                if gt_folder == 2:
                    merged_dict[key] = item
        else:
            merged_dict[key] = item
    ...
    return {
        ...
        "gt_folder_used": gt_folder
    }


def merge_users(folder1_path: str, folder2_path: str, output_path: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing users.json
        folder2_path (str): Path to second folder containing users.json
        output_path (str): Path for merged users.json output
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
...
def merge_schemas(folder1_path: str, folder2_path: str, output_path: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing schemas.json
        folder2_path (str): Path to second folder containing schemas.json
        output_path (str): Path for merged schemas.json output
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
...
def merge_projects(folder1_path: str, folder2_path: str, output_path: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing projects.json
        folder2_path (str): Path to second folder containing projects.json
        output_path (str): Path for merged projects.json output
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
...
def merge_project_groups(folder1_path: str, folder2_path: str, output_path: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing project_groups.json
        folder2_path (str): Path to second folder containing project_groups.json
        output_path (str): Path for merged project_groups.json output
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
...
def merge_assignments(folder1_path: str, folder2_path: str, output_path: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing assignments.json
        folder2_path (str): Path to second folder containing assignments.json
        output_path (str): Path for merged assignments.json output
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
...
def merge_question_groups(folder1_path: str, folder2_path: str, output_folder: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing question_groups folder
        folder2_path (str): Path to second folder containing question_groups folder
        output_folder (str): Path for merged question_groups folder
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
...
def merge_annotations(folder1_path: str, folder2_path: str, output_folder: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing annotations folder
        folder2_path (str): Path to second folder containing annotations folder
        output_folder (str): Path for merged annotations folder
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
...
def merge_ground_truths(folder1_path: str, folder2_path: str, output_folder: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        folder1_path (str): Path to first folder containing ground_truths folder
        folder2_path (str): Path to second folder containing ground_truths folder
        output_folder (str): Path for merged ground_truths folder
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
...
def merge_workspace(folder1_path: str, folder2_path: str, output_folder: str, gt_folder: int = 1) -> Dict:
    """
    ...
    Args:
        ...
        output_folder (str): Path for merged workspace folder
        gt_folder (int): Which folder to use as ground truth for conflicts (1 or 2)
    ...
    merge_report["videos"] = merge_videos(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "videos.json"), 
        gt_folder
    )
    
    merge_report["users"] = merge_users(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "users.json"), 
        gt_folder
    )
    
    merge_report["schemas"] = merge_schemas(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "schemas.json"), 
        gt_folder
    )
    
    merge_report["projects"] = merge_projects(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "projects.json"), 
        gt_folder
    )
    
    merge_report["project_groups"] = merge_project_groups(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "project_groups.json"), 
        gt_folder
    )
    
    merge_report["assignments"] = merge_assignments(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "assignments.json"), 
        gt_folder
    )
    
    merge_report["question_groups"] = merge_question_groups(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "question_groups"), 
        gt_folder
    )
    
    merge_report["annotations"] = merge_annotations(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "annotations"), 
        gt_folder
    )
    
    merge_report["ground_truths"] = merge_ground_truths(
        folder1_path, folder2_path, 
        os.path.join(output_folder, "ground_truths"), 
        gt_folder
    )
